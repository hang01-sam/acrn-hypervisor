...
#ifndef __AARCH64_GICV2_H__
#define __AARCH64_GICV2_H__
...
#define GIC_SPI_TARGET_CPU0  U(0x1)
#define GICD_ITARGETSR_DEF_VAL  \
    (GIC_SPI_TARGET_CPU0 | \
    (GIC_SPI_TARGET_CPU0 << 8) | \
    (GIC_SPI_TARGET_CPU0 << 16) | \
    (GIC_SPI_TARGET_CPU0 << 24))
