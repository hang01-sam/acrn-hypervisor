...
#ifndef __AARCH64_GICV3_H__
#define __AARCH64_GICV3_H__
...
#define CTLR_ENABLE_G1NS_SHIFT		0
#define CTLR_ENABLE_G1S_SHIFT		2
#define CTLR_ENABLE_G1NSA_SHIFT      1
#define CTLR_ARE_S_SHIFT		4
#define CTLR_ARE_NS_SHIFT		4
...
#define CTLR_ENABLE_G1NSA_BIT        BIT_32(CTLR_ENABLE_G1NSA_SHIFT)
...
/* ICC_CTLR bit definitions */
#define ICC_CTLR_EOI_BIT    BIT_32(1)
...
#define IGRPEN1_EL1_ENABLE_G1_SHIFT	0
#define IGRPEN1_EL1_ENABLE_G1_BIT	BIT_32(IGRPEN1_EL1_ENABLE_G1_SHIFT)
...
{
	return (uint32_t)read_icc_iar1_el1() & IAR0_EL1_INTID_MASK;
}
...
#define GICD_NUM_REGS(reg_name)	\
	INT_DIV_ROUNDUP(TOTAL_SHARED_INTR_NUM, (1 << reg_name##_SHIFT))

#define GICR_NUM_REGS(reg_name)	\
	INT_DIV_ROUNDUP(TOTAL_PRIVATE_INTR_NUM, (1 << reg_name##_SHIFT))
